...
Route::get('cross-join', [StudentController::class, 'crossJoin']);
Route::get('advance-join', [StudentController::class, 'advanceJoin']);
Route::get('subquery-join', [StudentController::class, 'subqueryJoin']);
